...
This follows the NVFP4 reference quantization in Transformer Engine, uses the
FlashInfer CUDA quantizer when available, and keeps 4over6 controlled by the
NVTE_NVFP4_* environment variables.
"""
