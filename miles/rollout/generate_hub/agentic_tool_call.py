...
Agent function contract:
  ...
  Raising miles.rollout.agent_function.InfraAbort discards the sample and
  records the abort's exit_status. Other exceptions keep today's behavior:
  the recorded session remains a sample for the reward model to score.
"""
