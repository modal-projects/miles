...
def get_rollout_endpoint_url(args, path: str) -> str:
    if endpoint := getattr(args, "rollout_endpoint_url", None):
        return f"{endpoint}{path}"
    return f"http://{args.sglang_router_ip}:{args.sglang_router_port}{path}"
