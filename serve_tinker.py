...
async def serve(args):
    ...
    if args.max_tokens_per_gpu is not None:
        # The trainer pads each packed microbatch to this multiple; a microbatch
        # holds max_tokens_per_gpu tokens per CP rank.
        pad_size = args.tensor_model_parallel_size * args.data_pad_size_multiplier
        microbatch_token_budget = args.max_tokens_per_gpu * args.context_parallel_size
        trainer_token_limit = microbatch_token_budget // pad_size * pad_size
