...
def test_lifecycle_diagnostics_include_v2_identity_and_exit_state(monkeypatch, tmp_path):
    class Sandbox:
        object_id = "sb-test"
...
@pytest.mark.asyncio
async def test_app_is_created_once_then_workers_only_look_it_up(monkeypatch):
    async_calls = []
    sync_calls = []
