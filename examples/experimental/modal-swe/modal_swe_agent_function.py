...
import tomllib
from modal_swe_sandbox import ModalSWEEnvironment, SandboxCommandTimeoutError, ensure_sandbox_app, sandbox_settings
...
async def run(
    ...
    **kwargs: Any,
    ...
    del kwargs
    ensure_sandbox_app(str(sandbox_settings()["app_name"]))
    queued_at = time.perf_counter()
    payload = {
        "base_url": base_url,
        "prompt": prompt,
